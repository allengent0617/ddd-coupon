...
public class UserRechargeControllerTest {
    ...
    public void testAddStock() throws Exception{
        ...
        given(this.userAccountService.recharge(userId,amount)).willReturn(Result.success(null));

        RechargeRequest request=new RechargeRequest(userId,amount);
        String content=mockMvc.perform(post("/recharge").contentType(MediaType.APPLICATION_JSON).characterEncoding("utf-8")
